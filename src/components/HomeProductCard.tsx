...
export const HomeProductCard: React.FC<HomeProductCardProps> = ({
      ...
      >
        ...
        <div className="w-full aspect-[4/5] sm:aspect-square rounded-2xl overflow-hidden relative bg-[#faf8f5]">
          ...
          <div className="absolute top-3 left-3 flex flex-wrap gap-1">
            <span className="text-[7.5px] uppercase tracking-widest bg-[#3A312D] text-[#e8dcc8] px-2.5 py-1 rounded-full font-semibold shadow-3xs font-poppins">
              {getPremiumTag()}
            </span>
          </div>
        </div>
        ...
        <div className="pt-4 flex flex-col items-center text-center flex-grow justify-between">
          <div className="w-full">
            <span className="text-[8px] uppercase tracking-[0.15em] text-[#cca062] font-semibold mb-1 block font-poppins">
              {brand.label}
            </span>
            ...
            <p className="text-[9.5px] text-[#6d5443]/65 font-light leading-relaxed mt-1 mb-2 max-w-[190px] mx-auto truncate">
          ...
          <div className="pt-2 mt-auto w-full border-t border-[#faf8f5]">
            <span className="text-[10px] sm:text-[11.5px] tracking-widest text-[#6d5443]/90 font-medium font-poppins block">
  ...
  return (
    <div
      onClick={onClick}
      className="group relative flex flex-col justify-between bg-white border border-[#e8dcc8]/40 rounded-2xl shadow-[0_4px_12px_rgba(109,84,67,0.02)] sm:hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(109,84,67,0.06)] hover:border-[#cca062]/35 transition-all duration-300 cursor-pointer overflow-hidden pb-3.5"
    >
      ...
      <div className="w-full aspect-[4/3] sm:aspect-square bg-[#faf8f5] overflow-hidden relative">
        ...
        <div className="absolute top-2.5 right-2.5">
          <span className={`text-[7.5px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider shadow-3xs border border-[#e8dcc8]/10 ${brand.bg} ${brand.text}`}>
            {brand.label}
          </span>
        </div>
        ...
        {discountAmount > 0 && (
          <div className="absolute top-2.5 left-2.5">
            <span className="text-[7.5px] px-2 py-0.5 bg-[#c96b71]/10 text-[#c96b71] font-bold rounded-full font-poppins border border-[#c96b71]/10">
              {discountAmount}% OFF
            </span>
          </div>
        )}
      ...
      <div className="p-3.5 flex flex-col items-center text-center flex-grow justify-between">
        <div className="w-full">
          <span className="text-[7.5px] uppercase tracking-widest text-[#6d5443]/50 font-bold block mb-0.5">
            {brand.label}
          </span>
          <h3 className="font-poppins font-semibold text-[10.5px] sm:text-[11.5px] leading-snug text-[#3A312D] line-clamp-1 group-hover:text-[#cca062] transition-colors mb-2">
            {product.product_name}
          </h3>
        </div>
        ...
        <div className="w-full mt-auto">
          <div className="flex flex-col items-center justify-center min-h-[32px]">
            {product.original_price && product.original_price > product.current_price ? (
              <>
                ...
                <span className="text-[11.5px] sm:text-[13px] text-[#3A312D] font-bold tracking-wide">
          ...
          <div className="mt-3 pt-2.5 border-t border-[#faf8f5] flex items-center justify-between w-full">
            ...
            <button className="w-6.5 h-6.5 rounded-full bg-[#faf8f5] border border-[#e8dcc8]/40 group-hover:bg-[#3A312D] group-hover:text-white transition-all flex items-center justify-center text-[#cca062] shadow-3xs cursor-pointer">
