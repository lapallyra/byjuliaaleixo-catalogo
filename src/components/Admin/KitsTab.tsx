              ...
              <div className="flex-1 overflow-y-auto p-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="p-3 bg-slate-100 rounded-xl text-xs font-bold text-slate-800 flex items-center gap-2">
                          ...
                          Kit Pronto (Seleção de Produtos)
                        </div>
                      </div>
                 ...
                 <div className="space-y-6">
                   <div className="bg-[#F5F5F7] p-6 border border-[#E5E5EA] rounded-2xl">
                     ...
                     <div className="mb-4 space-y-2 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
                       <label className="text-[10px] font-bold text-slate-700 uppercase tracking-wider block">
                         Selecione um Produto Existente para Compor o Kit
                       </label>
                       <div className="flex gap-2">
                         <select 
                           ...
                           onChange={(e) => {
                             ...
                             if (selectedId) {
                               addItemToKit('product', selectedId);
                               e.target.value = "";
                             }
                           }}
                         >
                           ...
                           {normalProducts.map(p => (
                             <option key={p.id} value={p.id}>
                               {p.product_name} - {formatCurrency(p.current_price || p.retail_price || 0)}
                             </option>
                           ))}
                         </select>
                       </div>
